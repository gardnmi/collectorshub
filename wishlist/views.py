...
def add_to_wishlist(request, pk):
    ...
    if request.headers.get('HX-Request'):
        ...
        button_html = render_to_string('wishlist/partials/wishlist_button.html', {
            'collectible': collectible, 
            'in_wishlist': True
        }, request=request)
...
def remove_from_wishlist(request, pk):
    ...
    if request.headers.get('HX-Request') and request.headers.get('HX-Current-URL', '').endswith(f'/collectibles/{pk}/'):
        # Render the wishlist button
        button_html = render_to_string('wishlist/partials/wishlist_button.html', {
            'collectible': collectible, 
            'in_wishlist': False
